...
- Users may use the Game for personal, non-commercial purposes only. The following actions are prohibited:
 ...
 3-1 Engaging in any illegal or criminal activities.

 3-2 Hacking the game server, modifying the game code, or using unauthorized automation software (macros).

 3-3 Impersonating others or harassing other users.
